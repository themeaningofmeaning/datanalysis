// Dylan Goldfus
// READS INPUT TO OUTPUT A GRAPH (Run Other Program first)
/************************************************************************
Note: I suggest opening this file using VIM for clear & organized viewing
*************************************************************************/
...
int main(int argc, char *argv[]) {
	...
	int sensor[1800], time[1800], i=0, clock, t1, count,b=0,c=0,d=0,e=0,f=0, p=0,g=0, v=0;
  	float temperature[1800], temp1[1800], temp2[1800], temp3[1800], temp4[1800], temp5[1800],sum[1800], hourhigh[1800], hourlow[1800], mean[1800], meansum1=0, meansum2=0, meansum3=0, meansum4=0, meansum5=0, meantotal1, low1, low2, low3, low4, low5, high1[23], high2, high3, high4, high5;
...
// safety check
  ...
  { printf("File %s cannot open!\n", argv[1]);
	...
	printf("\n\n***********************************************************\n\tFiles opened successfully.\n (Below is a plot of sensor temperature data)\n***********************************************************\n\n\n");

//scan the input file

	fprintf(f2, "       sensor1  sensor2  sensor3  sensor4  sensor5   mean\n");
/***********************************************************
//If I wanted to print the above fprintf statement inforation to the screen I 
//would simply activate the following line of code:
...
/***********************************************************
//If I wanted to print the above fprintf statement inforation to the screen I 
//would simply activate the following:
...
//Begin code for Extra Credit (Report 3)

i=23
while(high[i-1]<=(high[i]-10){
	while (v < high1[i]){
		printf(" ");
		v++
	}
